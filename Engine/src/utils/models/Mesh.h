...
#define IDENTITY_MAT glm::mat4(1.0f)
    ...
    public:
        ...
        Mesh(const std::vector<Vertex> &vertices, const std::vector<unsigned int> &indices, const uint32_t& shaderProgram, glm::mat4& viewMatrix, glm::mat4& projectionMatrix, glm::vec3 colour, uint32_t texture)
